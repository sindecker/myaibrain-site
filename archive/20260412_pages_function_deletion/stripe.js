...
export async function onRequestPost(context) {
  ...
  if (!signingKey) {
    // No hardcoded fallback: a public fallback would let anyone who reads
    // this source mint valid license keys. Fail loud instead.
    throw new Error(
      "LICENSE_SIGNING_KEY environment variable is required. " +
      "No hardcoded fallback is provided — set it in Cloudflare Pages env."
    );
  }
